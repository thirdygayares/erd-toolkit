                          ...
                          >
                            ...
                            {isExpanded ? (
                              <div className="space-y-2 border-t border-slate-200 bg-white p-3">
                                ...
                                {table.columns.map((column) => {
                                  ...
                                  return (
                                    <div
                                      ...
                                      className="grid grid-cols-[1fr_120px_44px_44px_44px] gap-2"
                                    >
                                      <input
                                        value={draftName}
                                        onChange={(event) =>
                                      ...
                                      <button
                                        ...
                                        className="rounded-md border border-slate-300 text-sm font-semibold text-slate-600 hover:bg-slate-50"
                                      ...
                                      >
                                        <KeyRound className="mx-auto h-4 w-4" />
                                      </button>
                                ...
                                <div className="grid grid-cols-[1fr_110px_44px_auto] gap-2 pt-1">
                                  <input
                                  ...
                                  <label className="inline-flex items-center justify-center rounded-md border border-slate-300 text-sm">
                                    <input
                                      type="checkbox"
                                  ...
                                  <div className="inline-flex items-center justify-center rounded-md border border-dashed border-slate-300 px-2 text-xs text-slate-500">
                                    Enter = Save
                                  </div>
                                </div>
